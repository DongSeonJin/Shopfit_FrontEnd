    ...
    return (
        <div style={{ margin: '0 20%' }}>
            ...
            {wishlistItems.map(item => (
                <div key={item.productId} style={{ display: 'flex', justifyContent: 'space-between', margin: '10px 0', alignItems: 'center' }}>
                    ...
                    <p style={{width: '15%', textAlign: 'right'}}>{productDetails[item.productId]?.price.toLocaleString()} 원</p>
